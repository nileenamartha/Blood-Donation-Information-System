...
<blockquote>
  <blockquote>
    <p>
      <button onClick="window.location.href='../acceptor_login/action_deactivate.php'">Yes</button><npbs><npbs> 
      <button onClick="window.location.href='../acceptor_login/Login_Acceptor.php'">No</button>
    </p>
  </blockquote>
</blockquote>
</div>
